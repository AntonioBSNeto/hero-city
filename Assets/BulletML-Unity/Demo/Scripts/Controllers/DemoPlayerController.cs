...
namespace Pixelnest.BulletML.Demo
{
  ...
  public class DemoPlayerController : MonoBehaviour
  {
    ...
    public AudioClip shootSound1; // Som do disparo 1
    public AudioClip shootSound2; // Som do disparo 2
    public AudioClip shootSound3; // Som do disparo 3
    ...
    private void Shoot()
    {
      ...
      switch (currentWeapon)
      {
        case 1:
          ...
          AudioManager.instance.PlaySoundEffect(shootSound1); // Reproduzir som do disparo 1
          break;
        case 2:
          if (shootTimer2 <= 0f)
          {
            ...
            AudioManager.instance.PlaySoundEffect(shootSound2); // Reproduzir som do disparo 2
          }
          break;
        case 3:
          if (shootTimer3 <= 0f)
          {
            ...
            AudioManager.instance.PlaySoundEffect(shootSound3); // Reproduzir som do disparo 3
          }
          break;
      }
    ...
    private void Die()
    {
      ...
      // Transitar para a tela de HighScore
